...
namespace KClinic2._1
{
    public partial class FormMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            if (ActivateThisChild("BaoCaoSuDungDichVuThe") == false)
            {
                View.HeThongBaoCao.BaoCaoSuDungDichVuThe frm = new View.HeThongBaoCao.BaoCaoSuDungDichVuThe();
                frm.MdiParent = this;
                frm.Show();
            }
        }
        ...
        {
            if (ActivateThisChild("BaoCaoTiepNhanPhongTuVan") == false)
            {
                View.HeThongBaoCao.BaoCaoTiepNhanPhongTuVan frm = new View.HeThongBaoCao.BaoCaoTiepNhanPhongTuVan();
                frm.MdiParent = this;
                frm.Show();
            }
        }
        ...
        {
            if (ActivateThisChild("BaoCaoKetQuaXetNghiem") == false)
            {
                View.HeThongBaoCao.BaoCaoXetNghiem frm = new View.HeThongBaoCao.BaoCaoXetNghiem();
                frm.MdiParent = this;
                frm.Show();
            }
        }
